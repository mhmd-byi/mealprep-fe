...
import { ArrowForwardIos, ArrowBackIos, MoreVert } from "@mui/icons-material";
  ...
  return (
    <DashboardLayoutComponent>
      <div className="flex flex-col justify-center items-center p-5 w-full lg:h-full my-auto">
        <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200 bg-white w-9/12 p-6 rounded-lg">
          <div className="md:pr-14">
            <div className="flex items-center">
              ...
              >
                ...
                <ArrowBackIos className="h-5 w-5" aria-hidden="true" />
              </button>
              <button
                type="button"
                ...
                >
                  <button
                    ...
                    className={classNames(
                      ...
                      !day.isSelected && day.isToday && "text-theme-color-1",
                      !day.isSelected &&
                        !day.isToday &&
                        day.isCurrentMonth &&
                        "text-gray-900",
