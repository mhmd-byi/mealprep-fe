...
const navigation = [
  ...
  { name: "Food Menu", href: "#", icon: DocumentMinusIcon, current: false },
  {
    name: "Subscribe your Meal Plan",
    href: "#",
    icon: BellSnoozeIcon,
    current: false,
  },
  ...
  return (
    <div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex h-16 shrink-0 items-center bg-white px-6 py-8">
                  ...
                  {navigation.map((item) => (
                    <li key={item.name}>
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? "bg-sidebar-color-1 text-white"
                            : "text-white hover:text-white hover:bg-sidebar-color-1",
                          "group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                        )}
                      >
                        <item.icon
